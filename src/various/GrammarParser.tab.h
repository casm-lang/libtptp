...
#line 60 "GrammarParser.tab.h"  // lalr1.cc:379
...
namespace libtptp
{
#line 137 "GrammarParser.tab.h"  // lalr1.cc:379
    ...
    class Parser
    {
      public:
        ...
        struct basic_symbol : Base
        {
            ...
            basic_symbol(
                typename Base::kind_type t, const Specification::Ptr v, const location_type& l );
        ...
        static inline symbol_type make_DUMMY( const Token::Ptr& v, const location_type& l );

        static inline symbol_type make_INTEGER( const std::string& v, const location_type& l );

        static inline symbol_type make_IDENTIFIER( const std::string& v, const location_type& l );
    ...
    inline Parser::token_number_type Parser::yytranslate_( token_type t )
    {
        ...
        const unsigned user_token_number_max_ = 260;
    ...
    template < typename Base >
    Parser::basic_symbol< Base >::basic_symbol(
        typename Base::kind_type t, const Token::Ptr v, const location_type& l )
    : Base( t )
    , value( v )
    , location( l )
    {
    ...
    template < typename Base >
    void Parser::basic_symbol< Base >::clear()
    {
        // User destructor.
    ...
    template < typename Base >
    bool Parser::basic_symbol< Base >::empty() const
    {
    ...
    inline Parser::token_type Parser::by_type::token() const
    {
        // YYTOKNUM[NUM] -- (External) token number corresponding to the
        // (internal) symbol number NUM (which must be that of a token).  */
        static const unsigned short int yytoken_number_[] = { 0, 256, 257, 258, 259, 260 };
        return static_cast< token_type >( yytoken_number_[ type ] );
    }
    // Implementation of make_symbol for each symbol type.
    Parser::symbol_type Parser::make_END( const location_type& l )
    {
        return symbol_type( token::END, l );
    }

    Parser::symbol_type Parser::make_DUMMY( const Token::Ptr& v, const location_type& l )
    {
        return symbol_type( token::DUMMY, v, l );
    }

    Parser::symbol_type Parser::make_INTEGER( const std::string& v, const location_type& l )
    {
        return symbol_type( token::INTEGER, v, l );
    }

    Parser::symbol_type Parser::make_IDENTIFIER( const std::string& v, const location_type& l )
    {
...
#line 989 "GrammarParser.tab.h"  // lalr1.cc:379
