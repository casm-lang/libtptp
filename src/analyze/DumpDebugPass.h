...
#ifndef _LIBTPTP_DUMP_DEBUG_PASS_H_
#define _LIBTPTP_DUMP_DEBUG_PASS_H_
...
namespace libtptp
{
    class DumpDebugPass final : public libpass::Pass
    {
      public:
        static char id;
    ...
    class DumpDebugVisitor final : public RecursiveVisitor
    {
      public:
