...
function( package_git_submodule PREFIX VERSION MODE TMP ) # ${ARGN} search paths
  ...
  foreach( PATH ${ARGN} )
	...
	set( ${PREFIX}_BUILD_ARGS -DBUILD_LIBZ3_SHARED=0 -DENABLE_EXAMPLE_TARGETS=0 -DUSE_OPENMP=0 -DUSE_LIB_GMP=0 -DBUILD_DOCUMENTATION=0 -DBUILD_PYTHON_BINDINGS=0 -DBUILD_DOTNET_BINDINGS=0 -DBUILD_JAVA_BINDINGS=0 -DINCLUDE_GIT_DESCRIBE=0 -DINCLUDE_GIT_HASH=0 )
      endif()
